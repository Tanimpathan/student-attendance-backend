...
exports.getStudentProfile = async (req, res, next) => {
    try {
        ...
        const dbError = new DatabaseError('student profile retrieval failed', 'DB_002', error);
        next(dbError);
    }
}
...
exports.markAttendance = async (req, res, next) => {
    try {
        ...
        const dbError = new DatabaseError('attendance marking failed', 'DB_002', error);
        next(dbError);
    }
}
...
exports.getTodayAttendance = async (req, res, next) => {
    try {
        ...
        const dbError = new DatabaseError('today attendance retrieval failed', 'DB_002', error);
        next(dbError);
    }
}
...
exports.editProfile = async (req, res, next) => {
    try {
        ...
        if (!first_name || !last_name) {
            const validationError = new ValidationError('First name and last name are required', 'VAL_001');
        ...
        const dbError = new DatabaseError('student profile update failed', 'DB_002', error);
        next(dbError);
    }
}
...
exports.getLoginActivity = async (req, res, next) => {
    try {
        ...
        const dbError = new DatabaseError('student login activity retrieval failed', 'DB_002', error);
        next(dbError);
    }
}